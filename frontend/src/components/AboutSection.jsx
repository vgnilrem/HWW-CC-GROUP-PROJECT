  ...
  return (
    <section className="relative bg-white text-black py-24 px-6 md:px-20">
      ...
      <div className="mb-20">
        ...
        <p className="text-gray-700 leading-relaxed">
          Grounded, accountable, and community-driven. Our team brings lived experience and professional expertise to the work of building real pathways from crisis to independence.
        </p>
      </div>
